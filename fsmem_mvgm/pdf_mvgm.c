/* 
 ...
 light				
  ...
  mex  -f mexopts_intel10amd.bat -output pdf_mvgm.dll pdf_mvgm.c
...
void pdf_mvgm(double * , double * , double * , double * , int , int , int , int , int , double * , 
				 ...
				 int nrhs, const mxArray *prhs[] )
{
 ...
 void pdf_mvgm(double *x , double *mu , double *sigma  , double *p , int d , int M , int N , int K , int V , 
	 double *pdf ,
