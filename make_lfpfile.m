...
%% Options
datafolder = 'E:\Canon_MMN_passiveAwake\'; %data source
outputfolder = 'G:\';%folder to save matlabData.mat file to (creates new subfolder per session)

% sessions = {'2018-02-20_11-04-13'};
